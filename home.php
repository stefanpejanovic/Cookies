...
//Warning: setccokie() expects parameter 2 to be string, array given
...
//serijalizovani podaci - kada postavljate niz kao vrednost cookija
echo '<br>' . $userCookie;

// Deserijalizacija - kada pokusavate da pristupite podacima ponovo iz kolacica
